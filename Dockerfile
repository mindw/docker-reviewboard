...
RUN apt-get update
RUN apt-get install -y build-essential python-dev python-psycopg2 git subversion mercurial libffi-dev libssl-dev python-svn libpcre3 libpcre3-dev python-ldap
